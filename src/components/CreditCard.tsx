...
return (
    <>
      <div
        className="credit-card aspect-[1.586/1] w-full max-w-sm p-6 rounded-xl shadow-md relative transition-all mx-auto overflow-hidden"
        style={{
